            ...
            <form method="POST" action="{{ route('products.store') }}">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="svitr_kods" class="mt-1 block w-full" required value="{{ old('svitr_kods') }}">
                    </div>

                    <div>
                        <label for="nosaukums">Nosaukums</label>
                        <input type="text" name="nosaukums" class="mt-1 block w-full" required value="{{ old('nosaukums') }}">
                    </div>

                    <div>
                        <label for="pardosanas_cena">Pārdošanas cena</label>
                        <input type="number" step="0.01" name="pardosanas_cena" class="mt-1 block w-full" required value="{{ old('pardosanas_cena') }}">
                    </div>

                    <div>
                        <label for="vairumtirdzniecibas_cena">Vairumtirdzniecības cena</label>
                        <input type="number" step="0.01" name="vairumtirdzniecibas_cena" class="mt-1 block w-full" value="{{ old('vairumtirdzniecibas_cena') }}">
                    </div>

                    <div>
                        <label for="daudzums_noliktava">Daudzums noliktavā</label>
                        <input type="number" name="daudzums_noliktava" class="mt-1 block w-full" value="{{ old('daudzums_noliktava') }}">
                    </div>

                    <div>
                        <label for="svars_neto">Svars (neto, kg)</label>
                        <input type="number" step="0.01" name="svars_neto" class="mt-1 block w-full" value="{{ old('svars_neto') }}">
                    </div>

                    <div>
                        <label for="nomGr_kods">Nomenklatūras grupas kods</label>
                        <input type="text" name="nomGr_kods" class="mt-1 block w-full" required value="{{ old('nomGr_kods') }}">
                    </div>
